...
const WhyUs = () => {
    return (
        <div className='font-primary bg-[#19a4630c] dark:bg-[#090b11] text-black dark:text-gray-200 duration-300 w-full flex flex-col items-center justify-center py-10 px-5'>
