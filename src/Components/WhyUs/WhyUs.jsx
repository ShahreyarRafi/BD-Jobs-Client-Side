...
const WhyUs = () => {
    ...
    return (
        <div className='bg-[#19a4630c] dark:bg-[#090b11]'>
            <motion.div ref={ref} initial={{ opacity: 0, y: 100 }} animate={controls}>
                <div className='font-primary text-black dark:text-gray-200 duration-300 w-full flex flex-col items-center justify-center py-10 px-5'>
                    <h2 className='font-primary text-3xl lg:text-4xl font-bold'>Why Us?</h2>
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 max-w-7xl dark:bg-[#090b11] duration-300 py-12">
                        <card className="border-green-500 bg-white border border-dashed hover:border-double rounded  py-7 px-5">
