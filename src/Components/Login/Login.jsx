                    ...
                    <div className="h-full">
                        <div className="g-6 flex h-full flex-wrap items-center justify-center text-neutral-800 dark:text-neutral-200">
                            <div className="w-full">
                                <div className="block bg-slate-100 border-b border-b-neutral-200 dark:bg-[#1d1b1d]">
                                                ...
                                                <form>
                                                    ...
                                                    <div className="relative mb-3" data-te-input-wrapper-init>
                                                        <input
                                                            ...
                                                            className="bg-slate-200 dark:bg-zinc-800 rounded text-white peer block min-h-[auto] w-full border border-stone-20 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
