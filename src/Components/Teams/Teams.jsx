...
const Teams = () => {
    return (
        <div>
            <div className="py-20 bg-gray-50 font-primary">
                <div className="container mx-auto px-6 md:px-12 xl:px-32">
                    <div className="mb-16 text-center">
                        <h2 className="mb-4 text-center text-2xl text-gray-900 font-bold md:text-4xl">Tailus blocks <span className="text-[#19a463]">leadership</span></h2>
